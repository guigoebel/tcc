...
\begin{listofabbrv}{SPMD}
        ...
        \item [IaaS] Infrainstructure as a Service
...
Este capítulo aborda a definição de Internet das coisas (do inglês Internet of Things -- IoT) [Atzori et al. 2010] e sobre Nuvem das coisas(do inglês Cloud of things -- CoT) hoje sendo tratado como uma próxima etapa para a IoT.  
...
Cloud of Things(CoT) ou também conhecido como ClouT, é um conceito relativamente novo, o qual utiliza de serviços de Computação em Nuvem como um facilitador para conectar a Internet das Coisas com pessoas, serviços de internet e estabelecer uma plataforma de comunicação e colaboração eficiente para a exploração de todos os recursos disponíveis, tornando o futuro da Internet das Coisas mais promissor. 
O serviço de Computação em Nuvem oferece como vantagem ao consumidor serviços como:
\begin{itemize}
\item Autosserviço sob demanda: Onde o consumidor pode provisionar por conta própria recursos de computação, como tempo de servidor e armazenamento em rede, automaticamente e conforme necessário.
\item Amplo acesso por rede: Recursos disponíveis por meio de rede e são acessador por meio de mecanismos padronizados que promovem o uso por dispositivos clientes leves ou ricos de diversas plataformas.
\item Agrupamento de recursos: Para atender a múltiplos consumidores em modalidade multi-inquilinos, os recursos do provedor são agrupados, com recursos físicos e virtuais diferentes dinamicamente atribuídos e reatribuídos conforme a demanda dos consumidores.
\item Serviço mensurado: Sistemas em nuvem controlam automaticamente e otimizam o uso de recursos.
\item Elasticidade rápida: Recursos podem ser provisionados e liberados elasticamente, em alguns casos automaticamente.
\end{itemize}
A fim de abranger todos os tipos de usuários, a computação em nuvem é provida de três tipos de "arquiteturas", ou modelos de serviço. São eles:
\begin{itemize}
\item IaaS: Em português, infraestrutura como um serviço, serve para fornecer recursos de processamento, armazenamento, comunicação de rede e outros recursos de computação fundamentais nos quais o consumidor pode instalar e exexutar softwares em geral, incluindo Sistemas Operacionais e aplicativos. O consumidor não gerencia nem controla a infraestrutura na nubem, mas tem o controle sobre os sistemas operacionais, armazenamento e aplicativos instalados.
\item PaaS: Em português, Plataforma como um serviço, é fornecido ao consumidor o recurso de instalar na infraestrutura na nuvem aplicativos criados ou adquiridos pelo consumidor, serviços e ferramentas suportados pelo fornecedor ou compatíveis. O consumidor não gerencia nem controla a infraestrutura na nuvem, incluindo rede, servidores ou armazenamento, mas tem controle sobre as aplicações instaladas.
\item SaaS: Software como um serviço, neste caso é fornecido para o consumidor o uso de aplicações do fornecedor executando em uma infraestrutura de nuvem. O consumidor não gerencia nem controla a infraestrutura na nuvem.

\end{itemize}
\begin{figure}[htbp]
  \centering \includegraphics[scale=.4]{modelo-nuvem}
\caption{Serviços } 
\label{figura}
\end{figure}
...
\section{EXEHDA - Atualmente}

Atualmente o middleware Exehda está funcionando de acordo com os componentes e divisões mostrados na figura abaixo.
\begin{figure}[htbp]
  \centering \includegraphics[scale=.4]{exehda-full}
\caption{Middleware EXEHDA 2015} 
\label{figura}
\end{figure}
